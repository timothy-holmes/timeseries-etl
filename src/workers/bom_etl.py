...
with TinyFlux(TINYFLUX) as db:
    q1 = MeasurementQuery() == "climate"
    start_count = db.count(q1)
    ...
    end_count = db.count(q1)
    print(f"num of records: {start_count} -> {end_count}")
